...
* Boqiang BMS007-LD43-16S-HW (requires `protocol_version: 0x26, override_pack: 1` reported by [@xdilian](https://github.com/syssi/esphome-seplos-bms/discussions/43))
* Boqiang BMS001-HS01-15S (requires `protocol_version: 0x26, override_pack: 1, override_cell_count: 10`, reported by [@xdilian](https://github.com/syssi/esphome-seplos-bms/discussions/43))
