...
* Boqiang BMS007-LD43-16S-HW (reported by [@xdilian](https://github.com/syssi/esphome-seplos-bms/discussions/43))
  ```
  # Requires custom settings
  protocol_version: 0x26
  override_pack: 1
  ```
* Boqiang BMS001-HS01-15S (reported by [@xdilian](https://github.com/syssi/esphome-seplos-bms/discussions/43))
  ```
  # Requires custom settings
  protocol_version: 0x26
  override_pack: 1
