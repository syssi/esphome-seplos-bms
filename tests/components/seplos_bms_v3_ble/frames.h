...
// SPA captures retained for upcoming sensor tests (no consumer yet, hence [[maybe_unused]]).
//
...
[[maybe_unused]] static const std::vector<uint8_t> SPA_DATA_1 = {
...
[[maybe_unused]] static const std::vector<uint8_t> SPA_DATA_2 = {
